<template>
  ...
  >
    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar" :style="{ padding: '4px 0 12px' }">
      ...
      >
        <!-- Branch the copy: filters narrowing things to zero is different from
             genuinely having no projects. The latter should invite creation. -->
...
const bottomLinks = computed(() => [
  ...
  // Hidden for now — re-enable when the Platform profiles feature is shipped.
